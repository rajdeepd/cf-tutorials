  ...
  var InteractiveMethods = /** @scope fabric.Canvas.prototype */ {
    ...
    _normalizePointer: function (object, pointer) {
      ...
      var activeGroup = this.getActiveGroup();
        //x = pointer.x,
        //y = pointer.y;
	// start - whiteboard:: Fix for selection of objects when a canvas is inside a div with scroll
	...
	var deviceHolder = this.wrapperEl.parentNode.parentNode.parentNode;
        x = pointer.x + this.wrapperEl.parentNode.scrollLeft + deviceHolder.scrollLeft -deviceOffsetX, 
        y = pointer.y + this.wrapperEl.parentNode.scrollTop + deviceHolder.scrollTop -deviceOffsetY;		
	//end - whiteboard:: Fix for selection of objects when a canvas is inside a div with scroll
      var isObjectInGroup = (
        activeGroup &&
        object.type !== 'group' &&
