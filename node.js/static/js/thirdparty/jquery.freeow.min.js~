...
this.element.click(this.options.onClick);this.element.hover(this.options.onHover);this.autoHide=false;};Freeow.prototype={attach:function(container){if(this.options.prepend){$(container).prepend(this.element);}else{$(container).html(this.element);}
