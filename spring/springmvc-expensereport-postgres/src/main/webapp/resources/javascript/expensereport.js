$(document).ready(function () {
    ...
    $("button.edit-expense-btn").on("click", function () {
        $.post(utils.url('/expense/'+$("input#expenseload").val()), {_method:"PUT", id : $("input#expenseload").val(), description : $(".textbox-a").val(), expenseTypeId : $("#expenseTypeId").val(), amount : $("input#amount").val()} , function(data) {
            $("a[data-tab=myExpenseContainer]").click();
        });
    });
